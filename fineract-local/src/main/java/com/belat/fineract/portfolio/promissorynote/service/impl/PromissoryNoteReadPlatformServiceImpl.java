...
public class PromissoryNoteReadPlatformServiceImpl implements PromissoryNoteReadPlatformService {
    ...
    public PromissoryNoteData retrieveOne(Long id) {
        ...
        //SavingsAccountData fund = savingsAccountReadPlatformService.retrieveOne(promissory.getFundSavingsAccount().getId());
        //SavingsAccountData investor = savingsAccountReadPlatformService.retrieveOne(promissory.getInvestorSavingsAccount().getId());
