...
public class CodeHelper {
    ...
    public PostCodeValueDataResponse createAddressTypeCodeValue(String addressTypeName) {
        ...
        return ok(() -> fineractClient.codeValues().createCodeValue(codeId, new PostCodeValuesDataRequest().name(addressTypeName)));
    }
    ...
    public PostCodeValueDataResponse createCountryCodeValue(String countryName) {
        ...
        return ok(() -> fineractClient.codeValues().createCodeValue(codeId, new PostCodeValuesDataRequest().name(countryName)));
    }
    ...
    public PostCodeValueDataResponse createStateCodeValue(String stateName) {
        ...
        return ok(() -> fineractClient.codeValues().createCodeValue(codeId, new PostCodeValuesDataRequest().name(stateName)));
    }

    public GetCodesResponse retrieveCodeByName(String name) {
        return ok(() -> fineractClient.codes().retrieveCodes()).stream().filter(r -> name.equals(r.getName())).findAny()
