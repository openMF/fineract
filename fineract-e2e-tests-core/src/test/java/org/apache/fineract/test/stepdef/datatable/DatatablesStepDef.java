...
public class DatatablesStepDef extends AbstractStepDef {
    ...
    public void whenDatatableCreated(String entityTypeStr) {
        ...
        PostDataTablesResponse response = ok(() -> fineractClient.dataTables().createDatatable(request));
    ...
    public void thenColumnsMatch(DataTable dataTable) {
        ...
        GetDataTablesResponse response = ok(() -> fineractClient.dataTables().getDatatable(datatableName));
